...
class Dwpose_model:
    def __init__(self, onnx_file=None, device="cuda"):
        if onnx_file is None:
            onnx_file = os.path.join(MODULE_PATH, "end2end.onnx")
    ...
    def __call__(self, oriImg):
        resized_img, center, scale = preprocess(oriImg, self.model_input_size)
