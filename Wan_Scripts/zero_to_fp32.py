...
#   or
#   python zero_to_fp32.py . output_dir/ --no_safe_serialization
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "We default it to 80GB in order for models to be able to run easily on free-tier google colab instances"
    ...
    parser.add_argument(
        "--sufix", type=str, default="pipe.dit.", help="sufix for screen in state dict"
    )
