...
model_path2 = "up2x-latest-denoise3x.pth"
model_path3 = "up3x-latest-denoise3x.pth"
model_path4 = "up4x-latest-denoise3x.pth"
...
cache_mode = 1
# alpha越小AI修复程度、痕迹越小，越模糊；alpha越大处理越烈，越锐化，色偏（对比度、饱和度增强）越大
# 可调区间：(0.7,1.3)，默认为1不调整
alpha = 1
# 超分模式，视频or图像文件夹
