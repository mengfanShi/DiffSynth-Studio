...
# `models/AnimateDiff/mm_sd_v15_v3.ckpt`: [link](https://huggingface.co/guoyww/animatediff/resolve/main/mm_sd_v15_v3.ckpt)
download_models(["DreamShaper_8", "AnimateDiff_v3"])
